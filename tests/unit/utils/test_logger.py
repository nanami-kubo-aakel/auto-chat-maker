...
def test_logger_config_setup_logging(monkeypatch):
...
def test_app_logger_info_logs_message(caplog):
...
def test_app_logger_error_logs_message(caplog):
...
def test_app_logger_debug_logs_message(caplog):
